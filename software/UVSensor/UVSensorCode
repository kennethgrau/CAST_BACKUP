...
const float UVDoseRequirement = 23.71; //23.71 mJ/cm^2 is the UV dose needed for bacteria on all surfaces
...
void loop()
{
  //loop to signify UV is in area. Under 300 mW/cm^2 indicates no UV
